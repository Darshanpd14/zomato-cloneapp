...
const resRoutes = require('./Routes/index');   // importing routes from routes file
...
mongoose.connect('mongodb+srv://darshanpd:dar@1998@cluster0.qgkbt.mongodb.net/FoodappDB?retryWrites=true&w=majority',
